  ...
  return (
    <div className="space-y-6">
      <div className="px-6 pt-8">
        ...
        <p className="text-muted-foreground">Institution settings and configuration</p>
      </div>
      <div className="px-6 space-y-4">
        <DataTable
          ...
          columns={[{"key": "key", "label": "Key"}, {"key": "value", "label": "Value"}, {"key": "category", "label": "Category"}, {"key": "updatedAt", "label": "Updated"}]}
        />
      </div>
    </div>
  );
