        ...
        {activeTab === "securityAudit" && (
          <div>
            <DataTable
              ...
              columns={[{"key": "auditType", "label": "Audit Type"}, {"key": "target", "label": "Target"}, {"key": "status", "label": "Status"}, {"key": "severity", "label": "Severity"}]}
            />
          </div>
        )}
        ...
        {activeTab === "vulnerabilityTracking" && (
          <div>
            <DataTable
              ...
              onDelete={((id: number) => vulnerabilityTrackingDelete.mutate({ id }))}
