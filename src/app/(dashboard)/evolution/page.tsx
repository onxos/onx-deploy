    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="retrospective" className="px-6">
        <TabsList>
          ...
          <TabsTrigger value="improvementBacklog">Improvement Backlog</TabsTrigger>
        ...
        <TabsContent value="retrospective">
          <DataTable
            ...
            columns={[{ key: 'title', label: 'Title' }, { key: 'goalReference', label: 'Goal Reference' }, { key: 'status', label: 'Status' }, { key: 'priority', label: 'Priority' }]}
          />
        </TabsContent>
        ...
        <TabsContent value="patternDetection">
          <DataTable
            ...
            columns={[{ key: 'pattern', label: 'Pattern' }, { key: 'type', label: 'Type' }, { key: 'occurrences', label: 'Occurrences' }, { key: 'confidence', label: 'Confidence' }]}
          />
        </TabsContent>
        ...
        <TabsContent value="recommendation">
          <DataTable
            ...
            columns={[{ key: 'title', label: 'Title' }, { key: 'status', label: 'Status' }, { key: 'cycle', label: 'Cycle' }]}
          />
        </TabsContent>
