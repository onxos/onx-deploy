  ...
  return (
    <div className="space-y-6">
      <div className="px-6 pt-8">
        ...
        <p className="text-muted-foreground">Compliance verification and audit tracking</p>
      </div>
      <div className="px-6 space-y-4">
        <DataTable
          ...
          columns={[{"key": "name", "label": "Name"}, {"key": "standard", "label": "Standard"}, {"key": "result", "label": "Result"}, {"key": "createdAt", "label": "Date"}]}
        />
      </div>
    </div>
  );
