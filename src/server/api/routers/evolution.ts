...
export const evolutionRouter = createTRPCRouter({
  ...
  retrospectiveById: protectedProcedure
    ...
    .query(async ({ input }) => {
      const result = await db
        .select()
        .from(retrospective)
        .where(eq(retrospective.id, input.id));
  ...
  improvementBacklogList: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      return db
        .select()
        .from(improvementBacklog)
        .where(conditions.length > 0 ? and(...conditions) : undefined)
        .orderBy(desc(improvementBacklog.id))
        .limit(input?.limit ?? 50)
        .offset(input?.offset ?? 0);
    }),
  ...
  improvementBacklogById: protectedProcedure
    ...
    .query(async ({ input }) => {
      const result = await db
        .select()
        .from(improvementBacklog)
        .where(eq(improvementBacklog.id, input.id));
      return result[0] ?? null;
    }),
  ...
  patternDetectionList: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      return db
        ...
        .where(conditions.length > 0 ? and(...conditions) : undefined)
        .orderBy(desc(patternDetection.id))
        .limit(input?.limit ?? 50)
        .offset(input?.offset ?? 0);
    }),
  ...
  patternDetectionById: protectedProcedure
    ...
    .query(async ({ input }) => {
      const result = await db
        .select()
        .from(patternDetection)
        .where(eq(patternDetection.id, input.id));
      return result[0] ?? null;
    }),
  ...
  recommendationList: protectedProcedure
    ...
    .query(async ({ input }) => {
      ...
      return db
        ...
        .from(recommendation)
        .where(conditions.length > 0 ? and(...conditions) : undefined)
        .orderBy(desc(recommendation.id))
        .limit(input?.limit ?? 50)
        .offset(input?.offset ?? 0);
    }),
